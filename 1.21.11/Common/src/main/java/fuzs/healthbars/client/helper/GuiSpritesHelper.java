...
public class GuiSpritesHelper {
    ...
    public static final ResourceLocation TOUGHNESS_FULL_SPRITE = HealthBars.id("hud/toughness_full");
    private static final ResourceLocation HEART_VEHICLE_FULL_SPRITE = HealthBars.id("hud/heart/vehicle_full");
    ...
    private static ResourceLocation getSprite(Gui.HeartType heartType, @Nullable LivingEntity livingEntity) {
        ...
        return HealthBars.id(resourceLocation.getPath());
    }
